 ...
 *
 * $Id: LongTicketLotteryServiceImpl.java 119 2011-05-28 07:40:43Z max.loukianov@gmail.com $
 *
 * Date Author Changes
 ...
 * @see
 */
public class LongTicketLotteryServiceImpl implements LotteryService {
	private final String lotteryid;
	private int price;

	public LongTicketLotteryServiceImpl(String lotteryid, int price) {
