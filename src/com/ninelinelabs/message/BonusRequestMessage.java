...
public class BonusRequestMessage extends Message {
	
	public static final String MSG_TYPE = ProtocolHPSP20.HPSP_20_BNUS_REQ;
	...
	public BonusRequestMessage(byte[] msg) {
		super(msg);
	}
