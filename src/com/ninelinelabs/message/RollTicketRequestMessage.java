...
public class RollTicketRequestMessage extends Message {
	
	public static final String MSG_TYPE = ProtocolHPSP20.HPSP_20_ROLL_TKT;
	
	private String terminal;
	private String rollid;

	public RollTicketRequestMessage(byte[] msg) {
		super(msg);
	}
