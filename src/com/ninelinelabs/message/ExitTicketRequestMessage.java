...
public class ExitTicketRequestMessage extends Message {
	
	public static final String MSG_TYPE = ProtocolHPSP20.HPSP_20_EXIT_REQ;
	
	private String terminal;
	private String game;

	
	public ExitTicketRequestMessage(byte[] msg) {
		super(msg);
	}
