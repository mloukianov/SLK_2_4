...
public class DepositWinRequestMessage extends Message {
	
	public static final String MSG_TYPE = ProtocolHPSP20.HPSP_20_CASH_REQ;
	
	private String terminal;
	private String game;

	public DepositWinRequestMessage(byte[] msg) {
		super(msg);
	}
