...
public class PrintConfirmMessage extends Message {
	
	public static final String MSG_TYPE = ProtocolHPSP20.HPSP_20_PRNT_CNF;
	...
	public PrintConfirmMessage(byte[] msg) {
		super(msg);
	}
