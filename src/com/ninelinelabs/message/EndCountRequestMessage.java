...
public class EndCountRequestMessage extends Message {
	
	public static final String MSG_TYPE = ProtocolHPSP20.HPSP_20_ENDCT_REQ;

	private String terminalid;
	private String cardno;

	public EndCountRequestMessage(byte[] msg) {
		super(msg);
	}
