...
public class ParameterGetMessage extends Message {
	
	public static final String MSG_TYPE = ProtocolHPSP20.HPSP_20_PARM_GET;
	
	private String terminal;
	private String param;


	public ParameterGetMessage(byte[] msg) {
		super(msg);
	}
